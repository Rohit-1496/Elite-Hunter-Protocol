...
Copy-Item "$ScriptDir\skills\CONFIRMATION_PROTOCOL.md" $ConfigDir -Force
Copy-Item "$ScriptDir\skills\REPORTING_PROTOCOL.md" $ConfigDir -Force
Copy-Item "$ScriptDir\skills\RECON_PROTOCOL.md" $ConfigDir -Force
